...
const rawItems = [
  ...
  { id: 'n9',  title: 'Live Lesson',       description: 'Join or host real-time teacher-led lessons',   category: 'Pages',    icon: Radio,           path: '/live-quiz',                bgClass: 'bg-rose-500/10',   iconClass: 'text-rose-500' },
